...
let mapDifficultyEasy = document.getElementById('easy')
let mapDifficultyMedium = document.getElementById('medium')
let mapDifficultyHard = document.getElementById('hard')

let mapPreviewOverlayOpened = false
let mapPreviewGrid = document.getElementById('mapPreviewGrid')

changeDifficulty(mapInfo.difficulty)
...
function changeDifficulty(difficulty){
    ...
    mapDifficultyEasy.style.boxShadow = "0 0 0px white"
    mapDifficultyMedium.style.boxShadow = "0 0 0px white"
    mapDifficultyHard.style.boxShadow = "0 0 0px white"
    if(difficulty == "easy"){
        mapInfo.cash = 300
        mapInfo.lives = 150
        mapDifficultyEasy.style.boxShadow = "0 0 4px white"
    }
    else if(difficulty == "medium"){
        mapInfo.cash = 200
        mapInfo.lives = 100
        mapDifficultyMedium.style.boxShadow = "0 0 4px white"
    }
    else{
        mapInfo.cash = 100
        mapInfo.lives = 50
        mapDifficultyHard.style.boxShadow = "0 0 4px white"
    }
